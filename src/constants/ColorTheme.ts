...
export const _TailWindColorThemeClasses: {
  ...
  light: {
    ...
    BTN_SECONDARY: "bg-violet-600 text-white",
...
export const TailWindColorThemeClasses: ITailWindColorThemeClasses = {
  ...
  BTN_PRIMARY: "bg-cyan-600 text-white dark:bg-violet-600 dark:text-white dark:hover:bg-cyan-700",
  BTN_SECONDARY: "bg-violet-600 text-white dark:bg-cyan-900 dark:text-white dark:hover:bg-violet-500",
