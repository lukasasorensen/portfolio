...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:max-w-[80%] group-[.is-user]:rounded-2xl group-[.is-user]:rounded-br-md group-[.is-user]:bg-cyan-300 group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-white dark:group-[.is-user]:bg-violet-600",
